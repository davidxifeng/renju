...
const boardScale = boardSize / 375
...
// 棋盘显示大小
export const STAGE_WIDTH = Math.max(boardSize, 375)
export const STAGE_HEIGHT = Math.max(boardSize, 375)

// 棋盘格子宽度
export const GRID_GAP = 23 * boardScale
